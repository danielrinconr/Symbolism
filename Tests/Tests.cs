...
namespace Tests
{
  public static class Extensions
  {
    ...
    public static MathObject AssertEqToDouble(this MathObject a, MathObject b, double tolerance = 0.000001)
    {
      ...
      if (Math.Abs(((DoubleFloat)((Equation)a).b).val - ((DoubleFloat)((Equation)b).b).val) > tolerance)
      {
    ...
    public static MathObject DispLong(this MathObject obj, int indent = 0)
    {
      ...
      {
        Console.WriteLine(new string(' ', indent) + ((Function)obj).name + "(");
        foreach (MathObject elt in ((Function)obj).args) elt.DispLong(indent + 2);
    ...
    {
      if (!(obj is Equation)) throw new Exception();
      return ((Equation)obj).a * item == ((Equation)obj).b * item;
    }
  ...
  class Program
  {
    static void Main()
    {
      ...
      };
      {
        ...
        new And(1, 2, 3, 4, 5, 6).Map(elt => (elt is Integer) && ((Integer)elt).val % 2 == 0 ? elt : false)
            .AssertEqTo(false);
        new Or(1, 2, 3).Map(elt => elt * 2)
            .AssertEqTo(new Or(2, 4, 6));
        new Or(1, 2, 3, 4, 5, 6).Map(elt => (elt is Integer) && ((Integer)elt).val % 2 == 0 ? elt : false)
            .AssertEqTo(new Or(2, 4, 6));
        ...
        Assert(((a + b) ^ c).Has(elt => (elt is Power) && ((Power)elt).exp == c), "Has - 6");
        Assert((x * (a + b + c)).Has(elt => (elt is Sum) && ((Sum)elt).Has(b)), "Has - 7");
        Assert((x * (a + b + c)).Has(elt => (elt is Sum) && ((Sum)elt).elts.Any(obj => obj == b)), "Has - 8");
        Assert((x * (a + b + c)).Has(elt => (elt is Product) && ((Product)elt).elts.Any(obj => obj == b)) == false, "Has - 9");
        #endregion
        #region FreeOf
        Assert((a + b).FreeOf(b) == false, "(a + b).FreeOf(b)");
        Assert((a + b).FreeOf(c), "(a + b).FreeOf(c)");
        Assert(((a + b) * c).FreeOf(a + b) == false, "((a + b) * c).FreeOf(a + b)");
        Assert((sin(x) + 2 * x).FreeOf(sin(x)) == false, "(sin(x) + 2 * x).FreeOf(sin(x))");
        Assert(((a + b + c) * d).FreeOf(a + b), "((a + b + c) * d).FreeOf(a + b)");
        Assert(((y + 2 * x - y) / x).FreeOf(x), "((y + 2 * x - y) / x).FreeOf(x)");
        Assert(((x * y) ^ 2).FreeOf(x * y), "((x * y) ^ 2).FreeOf(x * y)");
        #endregion
        #region Denominator
        {
      ...
      {
        Symbol sAC = new Symbol("sAC");
        Symbol sAB = new Symbol("sAB");
        Symbol vA = new Symbol("vA");
        Symbol vB = new Symbol("vB");
        Symbol vC = new Symbol("vC");
        Symbol a = new Symbol("a");
        Symbol tAC = new Symbol("tAC");
        Symbol tAB = new Symbol("tAB");
        And eqs = new And(tAB == tAC / 2);
        eqs.args.AddRange(Kinematic(sAC, vA, vC, a, tAC));
        eqs.args.AddRange(Kinematic(sAB, vA, vB, a, tAB));
        List<Equation> vals = new List<Equation> { vA == 10, vC == 30, tAC == 10 };
        eqs.EliminateVariables(tAB, sAC, vB, sAB)
           .IsolateVariable(a)
           .AssertEqTo(a == (vC - vA) / tAC)
           .SubstituteEqLs(vals)
           .AssertEqTo(a == 2);
        eqs.EliminateVariables(vB, a, tAB, sAC)
      ...
      #region PSE Example 2.7
      {
        ...
        List<Equation> vals = new List<Equation> { u == 63, v == 0, t == 2.0 };
        eqs.EliminateVariable(s)
           .AssertEqTo(v == a * t + u)
           .IsolateVariable(a)
           .AssertEqTo(a == (v - u) / t)
           .SubstituteEqLs(vals)
           .AssertEqTo(a == -31.5);
        eqs.EliminateVariable(a)
           .SubstituteEqLs(vals)
           .AssertEqTo(s == 63.0);
      }
      #endregion
      #region PSE Example 2.8
      {
        ...
        Symbol u1 = new Symbol("u1");
        Symbol v1 = new Symbol("v1");
        Symbol a1 = new Symbol("a1");
        Symbol t1 = new Symbol("t1");
        Symbol s2 = new Symbol("s2");
        Symbol u2 = new Symbol("u2");
        Symbol v2 = new Symbol("v2");
        ...
        List<Equation> vals = new List<Equation>
        {
            v1 == 45.0,
            u2 == 0,
            a2 == 3
        };
        eqs.EliminateVariables(s2, t1, a1, s1, v2, u1)
           .IsolateVariable(t2)
           .SubstituteEqLs(vals)
      ...
      {
        Symbol yA = new Symbol("yA");
        Symbol yB = new Symbol("yB");
        Symbol yC = new Symbol("yC");
        Symbol yD = new Symbol("yD");
        Symbol tA = new Symbol("tA");
        Symbol tB = new Symbol("tB");
        Symbol tC = new Symbol("tC");
        Symbol tD = new Symbol("tD");
        Symbol vA = new Symbol("vA");
        Symbol vB = new Symbol("vB");
        Symbol vC = new Symbol("vC");
        Symbol vD = new Symbol("vD");
        Symbol a = new Symbol("a");
        And eqs = new And();
        ...
        DoubleFloat.tolerance = 0.000000001;
        eqs.EliminateVariables(tB, tC, vC, yB, yD)
           .SubstituteEqLs(vals)
           .AssertEqTo(new Or(vD == -29.000000000000004, vD == -29.000000000000007));
        eqs.EliminateVariables(tB, tC, vC, yB, vD)
           .IsolateVariable(yD)
           .SubstituteEqLs(vals)
      ...
      #region PSE Example 4.3
      {
        ...
        Symbol xA = new Symbol("xA");
        Symbol xB = new Symbol("xB");
        Symbol xC = new Symbol("xC");
        Symbol yA = new Symbol("yA");
        Symbol yB = new Symbol("yB");
        Symbol yC = new Symbol("yC");
        Symbol vxA = new Symbol("vxA");
        Symbol vxB = new Symbol("vxB");
        Symbol vxC = new Symbol("vxC");
        Symbol vyA = new Symbol("vyA");
        Symbol vyB = new Symbol("vyB");
        Symbol vyC = new Symbol("vyC");
        Symbol tAB = new Symbol("tAB");
        Symbol tAC = new Symbol("tAC");
        Symbol ax = new Symbol("ax");
        Symbol ay = new Symbol("ay");
        Symbol vA = new Symbol("vA");
        Symbol thA = new Symbol("thA");
        Symbol Pi = new Symbol("Pi");
        And eqs = new And(
            vxA == vA * cos(thA),
            vyA == vA * sin(thA),
        ...
        List<Equation> zeros = new List<Equation> { xA == 0, yA == 0, ax == 0, vyB == 0 };
        List<Equation> vals = new List<Equation> { thA == (20).ToRadians(), vA == 11.0, ay == -9.8, Pi == Math.PI };
        eqs.EliminateVariables(xB, yC, vxB, vxC, vyC, yB, tAC, vxA, vyA, tAB)
           .SubstituteEqLs(zeros)
           .AssertEqTo(xC == -2 * cos(thA) * sin(thA) * (vA ^ 2) / ay)
           .SubstituteEqLs(vals)
           .AssertEqTo(xC == 7.9364592624562507);
        eqs.EliminateVariables(xB, yC, vxB, vxC, vyC, xC, vxA, tAC, vyA, tAB)
           .SubstituteEqLs(zeros)
      ...
      #region PSE Example 4.3 KinematicObjectABC
      {
        ...
        // (Assume his motion is equivalent to that of a particle.)
        // (b) What is the maximum height reached?
        KinematicObjectABC obj = new KinematicObjectABC("obj");
        Symbol yB = new Symbol("yB");
        Symbol xC = new Symbol("xC");
        Symbol ay = new Symbol("ay");
        Symbol thA = new Symbol("thA");
        ...
        List<Equation> numerical_vals = new List<Equation>
        {
            thA == (20).ToRadians(),
            vA == 11,
            ay == -9.8,
      ...
      #region PSE 5E Example 4.5
      {
        ...
        List<Equation> zeros = new List<Equation> { ax == 0, yC == 0 };
        List<Equation> vals = new List<Equation> { yA == 45, vA == 20, thA == (30).ToRadians(), ay == -9.8, Pi == Math.PI };
        DoubleFloat.tolerance = 0.00001;
        eqs.EliminateVariables(vC, vxA, vxC, vyC, vyA)
           .IsolateVariable(tAC)
      ...
      #region PSE 5E Example 4.6
      {
        ...
        List<Equation> vals = new List<Equation> { xA == 0, yA == 100, vxA == 40, vyA == 0, yB == 0, ax == 0, ay == -9.8, Pi == Math.PI };
        List<Equation> zeros = vals.Where(eq => eq.b == 0).ToList();
        DoubleFloat.tolerance = 0.00001;
      ...
      #region PSE 5E Example 4.7
      {
        ...
        List<Equation> vals = new List<Equation> { xA == 0, yA == 0, vxA == 25, vyA == 0, ax == 0, ay == -9.8, th == (35).ToRadians(), Pi == Math.PI };
        List<Equation> zeros = vals.Where(eq => eq.b == 0).ToList();
        DoubleFloat.tolerance = 0.00001;
        eqs.SubstituteEqLs(zeros)
      ...
      #region PSE 5E P4.9
      {
        ...
        List<Equation> vals = new List<Equation> { xA == 0, yA == 0.86, /* vxA */ vyA == 0, xB == 1.4, yB == 0, /* vxB vyB vB thB */ /* tAB */ ax == 0, ay == -9.8 };
        List<Equation> zeros = vals.Where(eq => eq.b == 0).ToList();
        DoubleFloat.tolerance = 0.00001;
        eqs.SubstituteEqLs(zeros)
      ...
      {
        if (!(elt is Sum)) return elt;
        List<MathObject> items = new List<MathObject>();
        foreach (MathObject item in ((Sum)elt).elts)
        {
          if (
            item is Product &&
          ...
          {
            MathObject u_ = ((Cos)(item as Product).elts[1]).args[0];
            MathObject v_ = ((Sin)(item as Product).elts[2]).args[0];
            Func<MathObject, bool> match = obj =>
              (obj as Product)?.elts[0] is Cos && ((Product)obj).elts[1] is Sin && ((Sin)((Product)obj).elts[1]).args[0] == u_ && ((Cos)((Product)obj).elts[0]).args[0] == v_;
      ...
      Func<MathObject, MathObject> SumDifferenceFormulaAFunc = elt =>
      {
        ...
        {
          if (
            (item as Product)?.elts[0] is Cos && (item as Product).elts[1] is Sin
            )
          {
            MathObject u_ = ((Cos)(item as Product).elts[0]).args[0];
            MathObject v_ = ((Sin)(item as Product).elts[1]).args[0];
            Func<MathObject, bool> match = obj =>
              (obj as Product)?.elts[0] is Cos && ((Product)obj).elts[1] is Sin && ((Sin)((Product)obj).elts[1]).args[0] == u_ && ((Cos)((Product)obj).elts[0]).args[0] == v_;
            if (items.Any(obj => match(obj)))
            {
      ...
      Func<MathObject, MathObject> DoubleAngleFormulaFunc =
        elt =>
        {
          if (!(elt is Product)) return elt;
          List<MathObject> items = new List<MathObject>();
          foreach (MathObject item in ((Product)elt).elts)
          {
            if (item is Sin)
            {
              MathObject sym = (item as Sin).args.First();
              if (items.Any(obj => (obj is Cos) && ((Cos)obj).args.First() == sym))
              {
                items = items.Where(obj => ((obj is Cos) && ((Cos)obj).args.First() == sym) == false).ToList();
            ...
            {
              MathObject sym = (item as Cos).args.First();
              if (items.Any(obj => (obj is Sin) && ((Sin)obj).args.First() == sym))
              {
                items = items.Where(obj => ((obj is Sin) && ((Sin)obj).args.First() == sym) == false).ToList();
                items.Add(sin(2 * sym) / 2);
              }
              else items.Add(item);
            }
      ...
      {
        if (!(elt is Product)) return elt;
        if (!((Product)elt).elts.Any(obj1 =>
         obj1 is Sin &&
         ((Product)elt).elts.Any(obj2 => obj2 == 1 / cos(((Sin)obj1).args[0])))) return elt;
        MathObject sin_ = ((Product)elt).elts.First(obj1 =>
         obj1 is Sin &&
         ((Product)elt).elts.Any(obj2 => obj2 == 1 / cos(((Sin)obj1).args[0])));
        MathObject arg = ((Sin)sin_).args[0];
      ...
      #region PSE 5E P4.11
      {
        ...
        DoubleFloat.tolerance = 0.00001;
        {
          List<Equation> vals = new List<Equation> { xA == 0, yA == 0, /* vxA vyA */ vA == 25.0, /* thA == 70.0, */ /* xB == 20.497, */ /* yB */ /* vxB */ vyB == 0, /* tAB */ ax == 0, ay == -9.8, Pi == Math.PI };
          List<Equation> zeros = vals.Where(eq => eq.b == 0).ToList();
          {
            // thA = ... || thA = ...
            MathObject expr = eqs
                ...
                .IsolateVariable(thA);
            // th_delta = ...
            MathObject th1 = ((Equation)((Or)expr).args[0]).b;
            MathObject th2 = ((Equation)((Or)expr).args[1]).b;
            Symbol th_delta = new Symbol("th_delta");
            eqs
      ...
      #region PSE 5E P4.13
      {
        ...
        DoubleFloat.tolerance = 0.00001;
        {
          List<Equation> vals = new List<Equation> { xA == 0, yA == 0, /* vxA vyA */ vA == 300.0, thA == (55).ToRadians(), /* xB yB vxB vyB */ tAB == 42, ax == 0, ay == -9.8, Pi == Math.PI };
          List<Equation> zeros = vals.Where(eq => eq.b == 0).ToList();
          {
            eqs.SubstituteEqLs(zeros)
      ...
      #region PSE 5E P4.19
      {
        ...
        Symbol ay = new Symbol("ay");
        Symbol Pi = new Symbol("Pi");
        Symbol cleared_by = new Symbol("cleared_by");
        Symbol goal_height = new Symbol("goal_height");
        And eqs = new And(
            vxA == vA * cos(thA),
            vyA == vA * sin(thA),
            vxB == vxA + ax * tAB,
      ...
      #region PSE 5E P4.21
      {
        ...
        Symbol Pi = new Symbol("Pi");
        Symbol d = new Symbol("d");
        Symbol thi = new Symbol("thi");
        Symbol vi = new Symbol("vi");
      ...
      #region PSE 5E E5.1
      {
        ...
        Symbol th = new Symbol("th");
        Symbol Fx = new Symbol("Fx");
        Symbol Fy = new Symbol("Fy");
        Symbol F1 = new Symbol("F1");
        Symbol th1 = new Symbol("th1");
        Symbol F1x = new Symbol("F1x");
        Symbol F1y = new Symbol("F1y");
        Symbol F2 = new Symbol("F2");
        Symbol th2 = new Symbol("th2");
        Symbol F2x = new Symbol("F2x");
        Symbol F2y = new Symbol("F2y");
        Symbol F3 = new Symbol("F3");
        Symbol th3 = new Symbol("th3");
        Symbol F3x = new Symbol("F3x");
        Symbol F3y = new Symbol("F3y");
        Symbol a = new Symbol("a");
        Symbol ax = new Symbol("ax");
        Symbol ay = new Symbol("ay");
      ...
      #region PSE 5E E5.4
      {
        ...
        // in the three cables.
        Symbol F = new Symbol("F");    // total force magnitude
        Symbol th = new Symbol("th");  // total force direction
        Symbol Fx = new Symbol("Fx");  // total force x-component
        Symbol Fy = new Symbol("Fy");  // total force y-component
        Symbol F1 = new Symbol("F1");
        Symbol th1 = new Symbol("th1");
        Symbol F1x = new Symbol("F1x");
        Symbol F1y = new Symbol("F1y");
      ...
      #region PSE 5E E5.6
      {
        ...
        Symbol incline = new Symbol("incline");
        Symbol Pi = new Symbol("Pi");
        Symbol xA = new Symbol("xA");
        Symbol yA = new Symbol("yA");
        Symbol vxA = new Symbol("vxA");
      ...
      #region PSE 5E E5.9
      {
        ...
        Symbol F_m1 = new Symbol("F_m1");      // total force on mass 1
        Symbol F_m2 = new Symbol("F_m2");      // total force on mass 2
        Symbol F1_m1 = new Symbol("F1_m1");    // force 1 on mass 1
        Symbol F2_m1 = new Symbol("F2_m1");    // force 2 on mass 1
        Symbol F1_m2 = new Symbol("F1_m2");    // force 1 on mass 2
        Symbol F2_m2 = new Symbol("F2_m2");    // force 2 on mass 2
        Symbol m1 = new Symbol("m1");
        Symbol m2 = new Symbol("m2");
        Symbol a = new Symbol("a");
        Symbol T = new Symbol("T");
        Symbol g = new Symbol("g");
        And eqs = new And(
        ...
        DoubleFloat.tolerance = 0.00001;
        {
          ...
          // a
          {
            eqs.EliminateVariables(F_m1, F_m2, F2_m1, F2_m2, F1_m1, F1_m2, T)
               .IsolateVariable(a)
               .AssertEqTo(a == (-1 * g * m1 + g * m2) / (m1 + m2))
               .SubstituteEqLs(vals)
               .AssertEqTo(a == 3.2666666666666666);
          }
          // T
          {
            eqs.EliminateVariables(F_m1, F_m2, F2_m1, F2_m2, F1_m1, F1_m2, a)
               .IsolateVariable(T)
               .AssertEqTo(T == 2 * g * m2 / (1 + m2 / m1))
               .SubstituteEqLs(vals)
               .AssertEqTo(T == 26.133333333333333);
          }
        }
      }
      #endregion
      #region PSE 5E E5.10 - Acceleration of Two Objects Connected by a Cord
      {
        ...
        Symbol F1_m1 = new Symbol("F1_m1");        // force 1 on mass 1
        Symbol F2_m1 = new Symbol("F2_m1");        // force 2 on mass 1
        Symbol F3_m1 = new Symbol("F3_m1");        // force 3 on mass 1
        Symbol th1_m1 = new Symbol("th1_m1");      // direction of force 1 on mass 1
        Symbol th2_m1 = new Symbol("th2_m1");      // direction of force 2 on mass 1
        Symbol th3_m1 = new Symbol("th3_m1");      // direction of force 3 on mass 1
        Symbol F1x_m1 = new Symbol("F1x_m1");      // x-component of force 1 on mass 1
        Symbol F2x_m1 = new Symbol("F2x_m1");      // x-component of force 2 on mass 1
        Symbol F3x_m1 = new Symbol("F3x_m1");      // x-component of force 3 on mass 1
        Symbol F1y_m1 = new Symbol("F1y_m1");      // y-component of force 1 on mass 1
        Symbol F2y_m1 = new Symbol("F2y_m1");      // y-component of force 2 on mass 1
        Symbol F3y_m1 = new Symbol("F3y_m1");      // y-component of force 3 on mass 1
        Symbol Fx_m1 = new Symbol("Fx_m1");        // x-component of total force on mass 1
        Symbol Fy_m1 = new Symbol("Fy_m1");        // y-component of total force on mass 1
        Symbol ax_m1 = new Symbol("ax_m1");        // x-component of acceleration of mass 1
        Symbol ay_m1 = new Symbol("ay_m1");        // y-component of acceleration of mass 1
        Symbol m1 = new Symbol("m1");
        ////////////////////////////////////////////////////////////////////////////////
        Symbol F1_m2 = new Symbol("F1_m2");        // force 1 on mass 2
        Symbol F2_m2 = new Symbol("F2_m2");        // force 2 on mass 2
        Symbol F3_m2 = new Symbol("F3_m2");        // force 3 on mass 2
        Symbol th1_m2 = new Symbol("th1_m2");      // direction of force 1 on mass 2
        Symbol th2_m2 = new Symbol("th2_m2");      // direction of force 2 on mass 2
        Symbol th3_m2 = new Symbol("th3_m2");      // direction of force 3 on mass 2
        Symbol F1x_m2 = new Symbol("F1x_m2");      // x-component of force 1 on mass 2
        Symbol F2x_m2 = new Symbol("F2x_m2");      // x-component of force 2 on mass 2
        Symbol F3x_m2 = new Symbol("F3x_m2");      // x-component of force 3 on mass 2
        Symbol F1y_m2 = new Symbol("F1y_m2");      // y-component of force 1 on mass 2
        Symbol F2y_m2 = new Symbol("F2y_m2");      // y-component of force 2 on mass 2
        Symbol F3y_m2 = new Symbol("F3y_m2");      // y-component of force 3 on mass 2
        Symbol Fx_m2 = new Symbol("Fx_m2");        // x-component of total force on mass 2
        Symbol Fy_m2 = new Symbol("Fy_m2");        // y-component of total force on mass 2
        Symbol ax_m2 = new Symbol("ax_m2");        // x-component of acceleration of mass 2
        Symbol ay_m2 = new Symbol("ay_m2");        // y-component of acceleration of mass 2
        Symbol m2 = new Symbol("m2");
        ////////////////////////////////////////////////////////////////////////////////
        Symbol incline = new Symbol("incline");
        Symbol T = new Symbol("T");                // tension in cable
        Symbol g = new Symbol("g");                // gravity
        Symbol n = new Symbol("n");                // normal force on block
        Symbol a = new Symbol("a");
        Symbol Pi = new Symbol("Pi");
        And eqs = new And(
      ...
      #region PSE 5E E5.10 - Acceleration of Two Objects Connected by a Cord - Obj3
      {
        ...
        Obj2 bal = new Obj2("bal");
        Obj3 blk = new Obj3("blk");
        Symbol th = new Symbol("th");
        Symbol T = new Symbol("T");                // tension in cable
        Symbol g = new Symbol("g");                // gravity
        Symbol n = new Symbol("n");                // normal force on block
      ...
      #region PSE 5E E5.12 - Experimental Determination of μs and μk
      {
        ...
        ////////////////////////////////////////////////////////////////////////////////
        Symbol incline = new Symbol("incline");
        Symbol f_s = new Symbol("f_s");            // force due to static friction
        Symbol g = new Symbol("g");                // gravity
        Symbol n = new Symbol("n");                // normal force on block
        Symbol a = new Symbol("a");
        Symbol Pi = new Symbol("Pi");
        Symbol mu_s = new Symbol("mu_s");          // coefficient of static friction
        And eqs = new And(
            F1x_m1 == F1_m1 * cos(th1_m1),
            F2x_m1 == F2_m1 * cos(th2_m1),
            F3x_m1 == F3_m1 * cos(th3_m1),
      ...
      #region PSE 5E E5.13 - The Sliding Hockey Puck
      {
        ...
        ////////////////////////////////////////////////////////////////////////////////
        Symbol s = new Symbol("s");                // displacement
        Symbol u = new Symbol("u");                // initial velocity
        Symbol v = new Symbol("v");                // final velocity
        Symbol a = new Symbol("a");                // acceleration
        Symbol t = new Symbol("t");                // time elapsed
        Symbol F1_m1 = new Symbol("F1_m1");        // force 1 on mass 1
        Symbol F2_m1 = new Symbol("F2_m1");        // force 2 on mass 1
        Symbol F3_m1 = new Symbol("F3_m1");        // force 3 on mass 1
        Symbol th1_m1 = new Symbol("th1_m1");      // direction of force 1 on mass 1
        ...
        Symbol f_s = new Symbol("f_s");            // force due to static friction
        Symbol f_k = new Symbol("f_k");            // force due to kinetic friction
        Symbol g = new Symbol("g");                // gravity
        Symbol n = new Symbol("n");                // normal force on block
        // var a = new Symbol("a");
        Symbol Pi = new Symbol("Pi");
        Symbol mu_s = new Symbol("mu_s");          // coefficient of static friction
        Symbol mu_k = new Symbol("mu_k");          // coefficient of kinetic friction
        And eqs = new And(
            a == ax_m1,
            v == u + a * t,
            s == (u + v) * t / 2,
        ...
        DoubleFloat.tolerance = 0.00001;
        {
          List<Equation> symbolic_vals = new List<Equation>
          {
              F1_m1 == n,
              F2_m1 == f_k,
              F3_m1 == m1 * g,
      ...
      #region PSE 5E E5.14 - Acceleration of Two Connected Objects When Friction Is Present
      {
        ...
        Symbol F2_m1 = new Symbol("F2_m1");        // force 2 on mass 1
        Symbol F3_m1 = new Symbol("F3_m1");        // force 3 on mass 1
        Symbol F4_m1 = new Symbol("F4_m1");        // force 4 on mass 1
        Symbol F5_m1 = new Symbol("F5_m1");        // force 5 on mass 1
        Symbol th1_m1 = new Symbol("th1_m1");      // direction of force 1 on mass 1
        Symbol th2_m1 = new Symbol("th2_m1");      // direction of force 2 on mass 1
        Symbol th3_m1 = new Symbol("th3_m1");      // direction of force 3 on mass 1
        Symbol th4_m1 = new Symbol("th4_m1");      // direction of force 4 on mass 1
        Symbol th5_m1 = new Symbol("th5_m1");      // direction of force 5 on mass 1
        Symbol F1x_m1 = new Symbol("F1x_m1");      // x-component of force 1 on mass 1
        Symbol F2x_m1 = new Symbol("F2x_m1");      // x-component of force 2 on mass 1
        Symbol F3x_m1 = new Symbol("F3x_m1");      // x-component of force 3 on mass 1
        Symbol F4x_m1 = new Symbol("F4x_m1");      // x-component of force 4 on mass 1
        Symbol F5x_m1 = new Symbol("F5x_m1");      // x-component of force 5 on mass 1
        Symbol F1y_m1 = new Symbol("F1y_m1");      // y-component of force 1 on mass 1
        Symbol F2y_m1 = new Symbol("F2y_m1");      // y-component of force 2 on mass 1
        Symbol F3y_m1 = new Symbol("F3y_m1");      // y-component of force 3 on mass 1
        Symbol F4y_m1 = new Symbol("F4y_m1");      // y-component of force 4 on mass 1
        Symbol F5y_m1 = new Symbol("F5y_m1");      // y-component of force 5 on mass 1
        Symbol Fx_m1 = new Symbol("Fx_m1");        // x-component of total force on mass 1
        Symbol Fy_m1 = new Symbol("Fy_m1");        // y-component of total force on mass 1
        Symbol ax_m1 = new Symbol("ax_m1");        // x-component of acceleration of mass 1
        Symbol ay_m1 = new Symbol("ay_m1");        // y-component of acceleration of mass 1
        ...
        Symbol m2 = new Symbol("m2");
        ////////////////////////////////////////////////////////////////////////////////
        Symbol F = new Symbol("F");                // force applied at angle on block
        Symbol th = new Symbol("th");              // angle of force applied on block
        Symbol T = new Symbol("T");                // tension in cable
        Symbol g = new Symbol("g");                // gravity
        Symbol n = new Symbol("n");                // normal force on block
        Symbol a = new Symbol("a");
      ...
      #region PSE 5E E5.14 - Acceleration of Two Connected Objects When Friction Is Present - Obj5
      {
        ...
        // 
        // Determine the magnitude of the acceleration of the two objects.
        Obj5 blk = new Obj5("blk");
        Obj3 bal = new Obj3("bal");
        Symbol F = new Symbol("F");                // force applied at angle on block
        Symbol th = new Symbol("th");              // angle of force applied on block
        Symbol T = new Symbol("T");                // tension in cable
        Symbol g = new Symbol("g");                // gravity
      ...
      #region PSE 5E P5.25 Obj
      {
        ...
        //
        //          T1 == F_g cos(th2) / sin(th1 + th2)
        Obj3 bag = new Obj3("bag");
        Symbol T1 = new Symbol("T1");
        Symbol T2 = new Symbol("T2");
        Symbol T3 = new Symbol("T3");
        Symbol F_g = new Symbol("F_g");
        Symbol th1 = new Symbol("th1");
        Symbol th2 = new Symbol("th2");
        And eqs = bag.Equations();
        List<Equation> vals = new List<Equation>
        {
            bag.ax == 0,
            bag.ay == 0,
      ...
      #region PSE 5E P5.31 Obj
      {
        ...
        // boat? (Disregard any other forces on the boat.)
        ////////////////////////////////////////////////////////////////////////////////
        Obj2 b1 = new Obj2("b1");            // boat in scenario 1 (same direction)
        Obj2 b2 = new Obj2("b2");            // boat in scenario 2 (opposite directions)
        Symbol m = new Symbol("m");
        ////////////////////////////////////////////////////////////////////////////////
        Symbol Pi = new Symbol("Pi");
        Symbol T1 = new Symbol("T1");
      ...
      #region PSE 5E P5.55 
      {
        ...
        Obj3 b = new Obj3("b");          // boy
        Obj3 c = new Obj3("c");          // chair
        Obj3 s = new Obj3("s");          // system
        Symbol T = new Symbol("T");        // rope tension
        Symbol n = new Symbol("n");        // normal force
        Symbol Fg_b = new Symbol("Fg_b");  // force due to gravity of the boy
        Symbol Fg_c = new Symbol("Fg_c");  // force due to gravity of the chair
        Symbol Fg_s = new Symbol("Fg_s");  // force due to gravity of the system
        Symbol a = new Symbol("a");        // acceleration
        Symbol Pi = new Symbol("Pi");
        Symbol g = new Symbol("g");
        MathObject eqs = new And(
      ...
      #region PSE 5E P5.59
      {
        ...
        Symbol pul1_F = new Symbol("pul1_F");      // magnitude of total force on pully 1
        Symbol pul1_m = new Symbol("pul1_m");      // mass of pully 1
        Symbol pul1_a = new Symbol("pul1_a");      // acceleration of pully 1
        Symbol pul2_F = new Symbol("pul2_F");      // magnitude of total force on pully 2
        Symbol pul2_m = new Symbol("pul2_m");      // mass of pully 2
        Symbol pul2_a = new Symbol("pul2_a");      // acceleration of pully 2
        Symbol T1 = new Symbol("T1");
        Symbol T2 = new Symbol("T2");
        Symbol T3 = new Symbol("T3");
        Symbol T4 = new Symbol("T4");
        Symbol T5 = new Symbol("T5");
        Symbol F = new Symbol("F");
        Symbol M = new Symbol("M");
        Symbol g = new Symbol("g");
        And eqs = new And(
      ...
      #region PSE 5E P5.69
      {
        ...
        Obj3 blk1 = new Obj3("blk1");
        Obj3 blk2 = new Obj3("blk2");
        Obj3 sys = new Obj3("sys");
        Symbol m1 = new Symbol("m1");
        Symbol m2 = new Symbol("m2");
        Symbol T = new Symbol("T");
        Symbol F = new Symbol("F");
      ...
      #region PSE 5E E7.7
      {
        ...
        Symbol F = new Symbol("F");
        Symbol d = new Symbol("d");
        Symbol Kf = new Symbol("Kf");
        Symbol Ki = new Symbol("Ki");
        Symbol m = new Symbol("m");
        Symbol vf = new Symbol("vf");
        Symbol vi = new Symbol("vi");
        And eqs = new And(
            W == F * d,
            W == Kf - Ki,
        ...
        List<Equation> vals = new List<Equation> { m == 6.0, vi == 0, F == 12, d == 3 };
        // vf
      ...
      #region PSE 5E E7.8
      {
        ...
        Symbol vf = new Symbol("vf");
        Symbol vi = new Symbol("vi");
        Symbol fk = new Symbol("fk");
        Symbol μk = new Symbol("μk");
        And eqs = new And(
            Kf == m * (vf ^ 2) / 2,
            Ki == m * (vi ^ 2) / 2,
            W == F * d,
      ...
      #region PSE 5E E7.11
      {
        ...
        Symbol vi = new Symbol("vi");
        Symbol fk = new Symbol("fk");
        Symbol W_s = new Symbol("W_s");
        Symbol W_f = new Symbol("W_f");
        Symbol x_max = new Symbol("x_max");
        And eqs = new And(
            W_s == k * (x_max ^ 2) / 2,
            Kf == m * (vf ^ 2) / 2,
            Ki == m * (vi ^ 2) / 2,
        ...
        // vf
        {
          List<Equation> vals = new List<Equation> { m == 1.6, vi == 0, fk == 0, k == 1000, x_max == -0.02 };
          eqs.EliminateVariables(ΣW, Kf, Ki, W_f, W_s)
             .IsolateVariable(vf)
             .LogicalExpand().SimplifyEquation().SimplifyLogical().CheckVariable(m)
             .AssertEqTo(
                 new Or(
        ...
        // vf
        {
          List<Equation> vals = new List<Equation> { m == 1.6, vi == 0, fk == 4, k == 1000, x_max == -0.02, d == 0.02 };
          eqs.EliminateVariables(ΣW, Kf, Ki, W_f, W_s)
             .IsolateVariable(vf)
             .LogicalExpand().SimplifyEquation().SimplifyLogical().CheckVariable(m)
             .SubstituteEqLs(vals)
      ...
      #region PSE 6E P7.3
      {
        ...
        List<Equation> vals = new List<Equation> { m == 80, len == 12, th == (60).ToRadians(), a == -9.8 };
    ...
    static void AssertEqual(DoubleFloat a, DoubleFloat b, double tolerance = 0.00000001)
    {
      if (Math.Abs(a.val - b.val) > tolerance)
        Console.WriteLine($"{a.val} and {b.val} are not equal");
    }
    static void AssertEqual(MathObject a, double b, double tolerance = 0.00000001)
    {
      DoubleFloat x = (DoubleFloat)a;
      DoubleFloat y = new DoubleFloat(b);
      if (Math.Abs(x.val - y.val) > tolerance)
        Console.WriteLine($"{x.val} and {y.val} are not equal");
    }
